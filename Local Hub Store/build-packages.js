...
const definitions = [
  ...
  { folder: "Keyboard Warrior PWA", id: "keyboard-warrior", name: "Keyboard Warrior", version: "2.6.0", category: "Games", description: "Put your typing speed and accuracy to the test.", icon: "KWIcon2.png" },
  { folder: "MediMap", id: "medimap", name: "MediMap", version: "1.4.1", category: "Tools", description: "Find medicines quickly by name, category, gondola, or shelf and manage pharmacy inventory.", icon: "MediFindLogo.png" },
