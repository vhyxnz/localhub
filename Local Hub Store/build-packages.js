...
const definitions = [
  ...
  { folder: "MediMap", id: "medimap", name: "MediMap", version: "1.1.0", category: "Tools", description: "Find medicines quickly by name, category, gondola, or shelf and manage pharmacy inventory.", icon: "MediFindLogo.png" },
  ...
  { folder: "Sweldo", id: "sweldo", name: "Sweldo", version: "1.2.0", category: "Finance", description: "A Philippine salary calculator for take-home pay and deductions.", icon: "SLogo.png" }
];
